...
# 	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanA2_45V.root -o $dataDir/rawPedAndMuon_muonScanA2_45V.root -O ../PlotsCalibMuon/muonScanA2_45V -r ../configs/DataTakingDB_202409_CAEN.csv
# 	
# fi
# 
...
# 	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanD1_45V.root -o $dataDir/rawPedAndMuon_muonScanD1_45V.root -O ../PlotsCalibMuon/muonScanD1_45V -r ../configs/DataTakingDB_202409_CAEN.csv
# fi
...
# 	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanD2_45V.root -o $dataDir/rawPedAndMuon_muonScanD2_45V.root -O ../PlotsCalibMuon/muonScanD2_45V -r ../configs/DataTakingDB_202409_CAEN.csv
# fi
...
# 	./Analyse -d 1 -f -P $dataDir/PedestalCalib_$pedScanH1_45V.root -i $dataDir/raw_muonScanH1_45V.root -o $dataDir/rawPed_muonScanH1_45V.root -O ../PlotsCalibMuon/Run$runNr -r ../configs/DataTakingDB_202409_CAEN.csv
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanH1_45V.root -o $dataDir/rawPedAndMuon_muonScanH1_45V.root -O ../PlotsCalibMuon/muonScanH1_45V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanH2_45V.root -o $dataDir/rawPedAndMuon_muonScanH2_45V.root -O ../PlotsCalibMuon/muonScanH2_45V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanB1_42V.root -o $dataDir/rawPedAndMuon_muonScanB1_42V.root -O ../PlotsCalibMuon/muonScanB1_42V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanB2_42V.root -o $dataDir/rawPedAndMuon_muonScanB2_42V.root -O ../PlotsCalibMuon/muonScanB2_42V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanC1_43_5V.root -o $dataDir/rawPedAndMuon_muonScanC1_43_5V.root -O ../PlotsCalibMuon/muonScanC1_43_5V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanC2_43_5V.root -o $dataDir/rawPedAndMuon_muonScanC2_43_5V.root -O ../PlotsCalibMuon/muonScanC2_43_5V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanE1_40V.root -o $dataDir/rawPedAndMuon_muonScanE1_40V.root -O ../PlotsCalibMuon/muonScanE1_40V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanE2_40V.root -o $dataDir/rawPedAndMuon_muonScanE2_40V.root -O ../PlotsCalibMuon/muonScanE2_40V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanF1_41V.root -o $dataDir/rawPedAndMuon_muonScanF1_41V.root -O ../PlotsCalibMuon/muonScanF1_41V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanF2_41V.root -o $dataDir/rawPedAndMuon_muonScanF2_41V.root -O ../PlotsCalibMuon/muonScanF2_41V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
...
if [ $2 == "muoncalib" ]; then
	...
	./Analyse -f -d 1 -s -i $dataDir/rawPed_muonScanG_46V.root -o $dataDir/rawPedAndMuon_muonScanG_46V.root -O ../PlotsCalibMuon/muonScanG_46V -r ../configs/DataTakingDB_202409_CAEN.csv
fi
